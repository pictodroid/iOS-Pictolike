...
- (void)drawRect:(CGRect)rect
{
    ...
    [bezierPath moveToPoint:CGPointMake(0.0,1.0)];
    [bezierPath addLineToPoint:CGPointMake(CGRectGetWidth(rect)-50, CGRectGetHeight(rect)-43 )];
...
//        [bezierPath addLineToPoint:CGPointMake(CGRectGetWidth(rect)-50, CGRectGetHeight(rect) - 1.0)];
//        [bezierPath setLineWidth:5.0];
//        [self.indicatorColor setStroke];
//        [bezierPath stroke];
//        
...
- (NSNumber *)tabWidth {
    ...
    if (!_tabWidth) {
        ...
        self.tabWidth = [NSNumber numberWithFloat:value/1.4];
    }
    return _tabWidth;
}
...
- (UIColor *)tabsViewBackgroundColor {
    ...
    if (!_tabsViewBackgroundColor) {
        ...
        self.tabsViewBackgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"TopBar.png"]];
    }
